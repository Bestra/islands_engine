defmodule IslandsEngine.Island do
  ...
  @doc """
  Checks if a given coordinate exists in an island.

  ## Examples

  iex> c = %IslandsEngine.Coordinate{row: 1, col: 1}
  iex> {:ok, island} = IslandsEngine.Island.new(:dot, c)
  ...
  defp add_coordinate(coordinates, %Coordinate{row: row, col: col}, {row_offset, col_offset}) do
    case Coordinate.new(row + row_offset, col + col_offset) do
      {:ok, new_coordinate} ->
        {:cont, MapSet.put(coordinates, new_coordinate)}
